...
class API {
  static const String baseUrl =
      'https://gofriendsgo.teqsuit.com/api/user';
  static const String baseImageUrl =
      'https://gofriendsgo.teqsuit.com/storage/';
  static const String loginUrl = 'https://gofriendsgo.teqsuit.com/api/';

 final loginToken=SharedPreferecesServices().getToken().toString();
}
//String tokenss =
